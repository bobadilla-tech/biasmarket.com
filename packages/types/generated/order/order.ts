...
export const review = async (storeId: string,
    orderId: string,
    reviewPaymentDto: ReviewPaymentDto, options?: Parameters<typeof customFetch>[1]): Promise<OrderStatusResponseDto> => {
...
export const advance = async (storeId: string,
    orderId: string,
    advanceFulfillmentDto: AdvanceFulfillmentDto, options?: Parameters<typeof customFetch>[1]): Promise<OrderStatusResponseDto> => {
...
export const cancel = async (storeId: string,
    orderId: string,
    cancelOrderDto: CancelOrderDto, options?: Parameters<typeof customFetch>[1]): Promise<OrderStatusResponseDto> => {
