...
export const create = async (createStoreDto: CreateStoreDto, options?: Parameters<typeof customFetch>[1]): Promise<StoreResponseDto> => {
...
export const update = async (storeId: string,
    updateStoreDto: UpdateStoreDto, options?: Parameters<typeof customFetch>[1]): Promise<StoreResponseDto> => {
