...
account (prod included) is one `pnpm` command, run from the repo root:

```bash
pnpm admin:promote:prod you@example.com                # existing account, prod
pnpm admin:create:prod alexandra@bobadilla.tech "Alexandra Flores"     # new account, prod
pnpm admin:create:prod carlos@bobadilla.tech "Carlos Bonifacio"     # new account, prod
pnpm admin:create:prod eliaz@bobadilla.tech "Eliaz Bobadilla"
