...
export function staleOrdersRule(staleOrderCount: number, holdWindowHours: number): Suggestion | null {
...
export function noRecentOrdersRule(recentOrderCount: number, windowDays: number): Suggestion | null {
...
export function topSellerRule(topProductName: string | null, unitsSold: number): Suggestion | null {
