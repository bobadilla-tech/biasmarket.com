...
export class PickupPointsService {
  ...
  private async findOwnedPoint(pointId: string, storeId: string, userId: string) {
  ...
  async update(pointId: string, storeId: string, userId: string, dto: UpdatePickupPointDto) {
