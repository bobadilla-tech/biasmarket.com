...
export class NotificationsController {
  ...
  @Get('unread-count')
  unreadCount(@Param('storeId') storeId: string, @Session() session: UserSession) {
  ...
  markRead(
    ...
    return this.notifications.markRead(notificationId, storeId, session.user.id);
  }

  @Post('read-all')
  markAllRead(@Param('storeId') storeId: string, @Session() session: UserSession) {
