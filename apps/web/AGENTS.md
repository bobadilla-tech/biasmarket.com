...
6. products/settings/orders pages — largest, highest-risk; migrate only once the pattern is proven across steps 2-5.
   ...
   - `products/page.tsx` and `orders/page.tsx` — not started; largest and highest-risk remaining, do these one at a time and re-verify (typecheck/test/build) after each.
