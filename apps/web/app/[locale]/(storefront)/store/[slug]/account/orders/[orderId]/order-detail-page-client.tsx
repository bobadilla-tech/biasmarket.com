...
export function OrderDetailPageClient() {
    ...
    return (
      ...
      >
        <div className="max-w-md w-full text-center flex flex-col gap-4">
          <ErrorState
            title={
              notFound ? t("orderDetail.notFoundTitle") : t("loggedOutTitle")
            }
            message={
              notFound ? t("orderDetail.notFoundBody") : t("loggedOutBody")
            }
          />
          <Link
            href={
  ...
  return (
    <main id="main-content" tabIndex={-1} className="min-h-dvh bg-gray-50">
