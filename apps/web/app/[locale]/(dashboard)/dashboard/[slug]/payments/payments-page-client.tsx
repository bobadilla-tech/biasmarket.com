              ...
              <table className="w-full text-sm">
                ...
                <tbody>
                  {paymentOrders.map((order) => {
                    ...
                    const needsReview = order.paymentStatus === "PENDING_PAYMENT" ||
                            ...
                            {needsReview && (
                              <>
                                <Button
                                  type="button"
                                  onClick={() =>
                                    setConfirmTarget({ orderId: order.id, decision: "approve" })}
                                ...
                                <Button
                                  ...
                                  variant="outline"
                                  onClick={() =>
                                    setConfirmTarget({ orderId: order.id, decision: "reject" })}
