...
import { ArrowLeft, Calendar, CheckCircle2, Layers, Package, Tag, XCircle } from "lucide-react";
        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <h1 className="text-3xl font-bold tracking-tight text-[#2d1649]">{product.name}</h1>
            </div>
          </div>
          <div className="flex flex-wrap items-center gap-2">
            ...
            <Badge
              variant="outline"
              className={cn("rounded-full border-[#eadcf7] px-3 py-1 text-xs", stockClassName)}
            >
