...
import { useAdminStores, useImpersonateStore, AdminStoresTable, type AdminStore } from "@/features/admin";
  ...
  return (
    <div className="bg-gray-50 px-6 py-10">
      <div className="mx-auto flex max-w-5xl flex-col gap-6">
        ...
        {!error && stores.length === 0 && <p className="text-sm text-gray-500">{t("empty")}</p>}

        {stores.length > 0 && (
          <AdminStoresTable
            stores={stores}
            impersonatingUserId={impersonate.isPending ? (impersonate.variables ?? null) : null}
